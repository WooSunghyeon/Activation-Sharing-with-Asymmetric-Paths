...
class Dfa_Block(nn.Module): # for DFA in ResNet
    def __init__(self, connect_channels):
        ...
        self.dfa = Feedback_Reciever(connect_channels)
...
class LW_Conv_Block(nn.Module): # for ASAP in ConvNet
    def __init__(self, in_channels, out_channels, kernel_size, stride, padding, wt = False):
        super(LW_Conv_Block, self).__init__()
        
        self.conv = Conv2d_FA_LW(in_channels, out_channels, kernel_size, stride, padding, wt = wt)
